...
# This module's own package, e.g. "worlds.metroid_dread". When the world is
...
# (e.g. `python logic_parser.py` from inside worlds/metroid_dread/ for local
    ...
    def get_node_connections(self, region_name: str, area_name: str, node_name: str) -> List[Tuple[str, str, str, Any]]:
        ...
        if node_type == "dock":
            ...
            if default_conn:
                ...
                # Get the door requirement (what's needed to pass through)
