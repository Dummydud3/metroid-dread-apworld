...
class MetroidDreadAccessibility(ItemsAccessibility):
    ...
    **Items:** ensure all logically relevant items can be acquired. Some items, such as keys, may be self-locking, and
    ...
    already be reachable with that same collection state. During generation,
    Minimal/Items are upgraded to Full so the fill cooperates with that guarantee.
    """
    # Prefer Full so YAML defaults match the victory-implies-90% clearance rule.
