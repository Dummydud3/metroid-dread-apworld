...
def test_gui_basic():
    ...
    from worlds.metroid_dread.DreadSeedManager import DreadSeedManager
    ...
    try:
        ...
        assert loaded["game"] == "Metroid Dread"
        assert "Metroid Dread" in loaded
